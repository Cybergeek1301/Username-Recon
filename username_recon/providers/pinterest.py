"""Pinterest provider that checks whether a Pinterest profile exists by username.
...
def check(username, timeout=5.0):
    ...
    profile_data = {}
    # Optionally, we could fetch more details with a GET request or Pinterest API
