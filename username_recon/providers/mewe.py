"""Mewe provider that checks whether a Mewe profile exists by username.

This example uses a lightweight HTTP request and returns a standard result dict:
{
  "service": "mewe",
  "url": "https://www.mewe.com/<username>",
  "found": True/False,
  "profile_data": { ... }
}
...
def check(username, timeout=5.0):
    ...
    profile_data = {}
    # Optionally, we could fetch more details with a GET request or Mewe API
